...
class RentalLists extends StatefulWidget {
  @override
  _RentalListsState createState() => _RentalListsState();
}

class _RentalListsState extends State<RentalLists> {
  List userRentalList = [];
  @override
  void initState() {
    super.initState();
  ...
  fetchDatabaseList() async {
    dynamic resultant = await databaseManager().getRentalList();
